...
(declare-const |nondet$symex::nondet430| (_ BitVec 32))
...
(declare-const |nondet$symex::nondet431| (_ BitVec 32))
...
(assert 
 ...
 (= |c:@F@main::$tmp::return_value$___VERIFIER_nondet_uint$1?1!0&0#1| |nondet$symex::nondet430|))
...
(assert 
 ...
 (= |c:@F@main::$tmp::return_value$___VERIFIER_nondet_uint$2?1!0&0#1| |nondet$symex::nondet431|))
