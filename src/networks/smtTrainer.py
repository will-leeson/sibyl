...
from utils.utils import ModifiedMarginRankingLoss, train_model, getCorrectProblemTypes, evaluate, SMTDataset
...
if __name__ == '__main__':
	...
	train_set = SMTDataset(trainLabels, "../../data/smtFiles/")
	val_set = SMTDataset(valLabels, "../../data/smtFiles/")
	test_set = SMTDataset(testLabels, "../../data/smtFiles/")
